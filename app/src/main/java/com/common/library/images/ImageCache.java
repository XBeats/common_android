 ...
 * {@link ImageWorker#setImageCache(android.support.v4.app.FragmentManager, ImageCacheParams)}.
 */
public class ImageCache {
	...
	/**
	 * Create a new ImageCache object with cache parameters.
	 * 
	 * @param cacheParams
    ...
    /**
     * Create a new {@link ImageCache} object with disk cache directory name.
     * @param context
     * @param diskCacheDirName directory to save image disk cache.
     */
    public ImageCache(Context context, String diskCacheDirName){
    	this(new ImageCacheParams(context, diskCacheDirName));
    }
    ...
    public static final class ImageCacheParams {
        ...
        public static final String DEFAULT_DISK_DIR_NAME = "imageCaches";
        ...
        public ImageCacheParams(Context context){
        	this(context, DEFAULT_DISK_DIR_NAME);
        }

        public ImageCacheParams(Context context, String diskCacheDirName) {
            diskCacheDir = ImageCache.getDiskCacheDir(context, diskCacheDirName);
        }
        
		/**
		 * Default disk cache directory is {@link Context#getCacheDir()} + "/" +
		 * {@link ImageCacheParams#DEFAULT_DISK_DIR_NAME} or
		 * {@link Context#getExternalCacheDir()} + "/" +
		 * {@link ImageCacheParams#DEFAULT_DISK_DIR_NAME}
		 */
        ...
        /**
         * Default memory cache size is {@link ImageCache#DEFAULT_MEM_CACHE_SIZE}
         * @param memCacheSize
         */
        ...
        /**
         * Default disk cache size is {@link ImageCache#DEFAULT_DISK_CACHE_SIZE}
         * @param diskCacheSize
         */
        ...
        /**
         * Default compress format is {@link ImageCache#DEFAULT_COMPRESS_FORMAT}
        ...
        /**
         * Default compress quality is {@link ImageCache#DEFAULT_COMPRESS_QUALITY}
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath =
                Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ||
                        !isExternalStorageRemovable() ? getExternalCachePath(context) :
    ...
    public static String getExternalCachePath(Context context) {
        ...
        return new File(Environment.getExternalStorageDirectory().getPath() + cacheDir).getPath();
    }
